...
adresse2          = re.compile('[.\w-]{1,20}?(?:\s)?(?:straße|str.|str|straße|ufer|allee|hof|gasse|graben|chaussee|wache|weg|platz|promenade|pforte|pfad|damm|tor|brücke|berg)', re.IGNORECASE)
...
regex_type = {
  ...
  "adresse"           : adresse,
  "adresse2"         : adresse2,
  "adresseAlt"           : adresse_alternative,
  "plz"               : plz,
  "objnr"             : objnr,
  "behoerde"             : behoerde
}
