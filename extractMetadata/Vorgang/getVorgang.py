    ...
    #             continue
            ...
            if 'FORMCHECKBOX' in inhalt:
                ...
                if pages<=5:
                    ...
                    wrongFormatList.append(files[i])
                """
                wrongFormatList.append(files[i]) ## Provisorisch hinzugefügt, da python-tika nicht verwendet
                ## Provisorisch auskommentiert, da python-tika nicht verwendet
                continue
...
class findVorgang:
    def __init__(self, files,path,considerDocName,methode,docxVorhanden):
        ...
        ###############################################
        self.all=mainProcess(self.files,self.filePath,self.considerDocName,self.methode,self.docxVorhanden)
